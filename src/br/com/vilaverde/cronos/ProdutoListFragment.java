...
import br.com.vilaverde.cronos.view.produtos.DepartamentoAdapter;
import br.com.vilaverde.cronos.view.produtos.ProdutosDetalhe;

/**
 * A list fragment representing a list of Produtos. This fragment also supports
...
public class ProdutoListFragment extends ListFragment {
	...
	private List<Departamento> lstDepartamentos = null;
...
//				android.R.id.text1, DummyContent.ITEMS));
    	...
    	// Instanciar o Helper 
        DepartamentosHelper helper = new DepartamentosHelper(this.getActivity());
        ...
        DepartamentoAdapter adapter = new DepartamentoAdapter(this.getActivity(), lstDepartamentos);
...
//		mCallbacks.onItemSelected(DummyContent.ITEMS.get(position).id);
		mCallbacks.onItemSelected(String.valueOf(lstDepartamentos.get(position).getId()));
		Log.v("ProdutoList", "Clicou Position: "+position+" Id = "+lstDepartamentos.get(position).getId());
